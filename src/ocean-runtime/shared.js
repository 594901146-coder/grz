...
var CLEAR_COLOR = [0.082, 0.094, 0.141, 1.0],
    GEOMETRY_ORIGIN = [-1000.0, -1000.0],
    SUN_DIRECTION = [-1.0, 1.0, 1.0],
    OCEAN_COLOR = [0.025, 0.006, 0.070],
    SKY_COLOR = [5.2, 3.0, 12.0],
    EXPOSURE = 0.35,
...
var animationScope = typeof window !== 'undefined' ? window : self;
var requestAnimationFrame = animationScope.requestAnimationFrame ||
    animationScope.webkitRequestAnimationFrame ||
    animationScope.mozRequestAnimationFrame || animationScope.msRequestAnimationFrame;
